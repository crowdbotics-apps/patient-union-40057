"""
Django settings for patient_union_40057 project.
...
ROOT_URLCONF = 'patient_union_40057.urls'
...
WSGI_APPLICATION = 'patient_union_40057.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_union_40057 API",
    "DESCRIPTION": "API documentation for patient_union_40057 App",
    "VERSION": "v1",
}
